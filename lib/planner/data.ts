...
export const WEEKS: Week[] = [
  ...
  { id: 2, label: "Settimana 3", phase: 2, dates: "11–17 Mag", phaseLabel: "FASE 2 — Ripasso Intensivo", focus: "Focus: Approfondimenti" },
  { id: 3, label: "Settimana 4", phase: 2, dates: "18–24 Mag", phaseLabel: "FASE 2 — Ripasso Intensivo", focus: "Focus: Integrazioni" },
  { id: 4, label: "Settimana 5", phase: 2, dates: "25–31 Mag", phaseLabel: "FASE 2 — Ripasso Intensivo", focus: "Focus: Completamento" },
  { id: 5, label: "Settimana 6", phase: 3, dates: "1–5 Giu", phaseLabel: "FASE 3 — Ripasso Finale", focus: "Psicologia 5 Giu" },
  { id: 6, label: "Settimana 7", phase: 3, dates: "7–12 Giu", phaseLabel: "FASE 3 — Ripasso Finale", focus: "Esami finali" },
]
...
export const DAILY: DailySchedule = {
  "2026-04-27": {
    ...
    week: 0,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Introduzione + Modalità comunicative" },
      { sub: "radio", dur: "1.5h", topic: "Radiodays Cap. 1-2 — Marconi, nascita radio, EIAR" },
      { sub: "est", dur: "1h", topic: "Lady Sapiens 1 — Metodi scientifici (bacino, coclea, DNA)" },
      { sub: "genere", dur: "1.5h", topic: "Inq. Visuale Cap. 1 — Eco-visioni, media ecology (Postman)" },
    ],
  },
  "2026-04-28": {
    label: "Mar 28 Apr",
    ...
    week: 0,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Gesti — tipi, parametri, Cherologia" },
      { sub: "radio", dur: "1.5h", topic: "Radiodays Cap. 3-4 — Radio e fascismo, propaganda" },
      { sub: "scog", dur: "1h", topic: "Cap. 1 — Introspezione + Comportamentismo (Pavlov, Watson, Skinner)" },
    ],
  },
  "2026-04-29": {
    label: "Mer 29 Apr",
    ...
    week: 0,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Sguardi — Optologia, parametri formazionali" },
      { sub: "radio", dur: "1.5h", topic: "Radiodays Cap. 5-6 — Dopoguerra, RAI, Alto Gradimento" },
      { sub: "scog", dur: "1h", topic: "Cap. 1 — Svolta cognitivista: Tolman, Chomsky" },
  ...
  "2026-04-30": {
    ...
    week: 0,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Credenze, Inferenze, Rete esplicativa" },
      { sub: "est", dur: "1.5h", topic: "Lady Sapiens 2 — Artigianato, ago, ipotesi donna artista" },
      { sub: "genere", dur: "1h", topic: "Inq. Visuale Cap. 3 — Immaginari ibridi, cyborg (Haraway)" },
    ],
  },
  ...
  "2026-05-03": {
    ...
    week: 0,
    sessions: [
      { sub: "psico", dur: "1h", topic: "Emozioni — Darwin / Ekman / Lewis" },
      { sub: "radio", dur: "1h", topic: "Ripasso Radiodays Cap. 1-6 con timeline" },
      { sub: "scog", dur: "0.5h", topic: "Ripasso Cap. 1 Comportamentismo + Cognitivismo" },
  ...
  "2026-05-04": {
    ...
    sessions: [
      ...
      { sub: "radio", dur: "1.5h", topic: "Radiodays Cap. 7-8 — Radio libere, sentenza 202/1976, web radio" },
      { sub: "scog", dur: "1h", topic: "Cap. 2 — Marr: tre livelli di spiegazione" },
      { sub: "genere", dur: "1.5h", topic: "Inq. Visuale Cap. 4 — Attivismo digitale, synopticon" },
    ],
  },
  "2026-05-05": {
    label: "Mar 5 Mag",
    ...
    week: 1,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Inganno — forme, condizioni, smascheramento" },
      { sub: "est", dur: "1.5h", topic: "Lady Sapiens 3 — Man the Hunter sfatato, cacciatrici" },
      { sub: "genere", dur: "1h", topic: "Inq. Visuale Cap. 5 — Fotografia: studium/punctum (Barthes)" },
    ],
  },
  "2026-05-06": {
    label: "Mer 6 Mag",
    ...
    week: 1,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Dibattito politico — Ethos, Dominanza, Discredito" },
      { sub: "radio", dur: "1.5h", topic: "Televisioni Cap. 1 — Origini TV 1938-1954" },
      { sub: "scog", dur: "1h", topic: "Cap. 2 — Algoritmi della visione, stadi, vincoli" },
      { sub: "genere", dur: "1.5h", topic: "Inq. Visuale Cap. 6 — Corpi femminili nello sport, framing power" },
    ],
  },
  "2026-05-07": {
    label: "Gio 7 Mag",
    ...
    week: 1,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Ironia + Contagio emotivo + Empatia" },
      { sub: "est", dur: "1.5h", topic: "Dissonanze — Intro + Schema radiale 6 categorie" },
      { sub: "genere", dur: "1h", topic: "Inq. Visuale Cap. 7 — Culture jamming: subvertising" },
    ],
  },
  "2026-05-08": { label: "Ven 8 Mag", busy: true, week: 1 },
  "2026-05-09": { label: "Sab 9 Mag", busy: true, week: 1 },
  "2026-05-10": {
    label: "Dom 10 Mag",
    hours: "3h",
    sunday: true,
    week: 1,
    sessions: [
      { sub: "psico", dur: "1h", topic: "Insulti e Ridicolizzazione" },
      { sub: "radio", dur: "1h", topic: "Ripasso Radiodays Cap. 1-8 + Televisioni Cap. 1" },
      { sub: "scog", dur: "0.5h", topic: "Ripasso Cap. 1-2 Marr + Algoritmi" },
      { sub: "genere", dur: "0.5h", topic: "Verifica settimanale" },
    ],
  },
  "2026-05-11": {
    label: "Lun 11 Mag",
    ...
    week: 2,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Manuale: Scopi / Credenze / Risorse" },
      { sub: "radio", dur: "1.5h", topic: "Televisioni Cap. 2 — Anni '60-'70, servizio pubblico" },
      { sub: "est", dur: "1h", topic: "Il Bello — da Pitagora a Duchamp" },
      { sub: "genere", dur: "1.5h", topic: "Inq. Visuale Cap. 8 — Moda e identità, trickle down, Rana Plaza" },
    ],
  },
  "2026-05-12": {
    label: "Mar 12 Mag",
    ...
    week: 2,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Manuale: Comunicazione indiretta (sovrascopi)" },
      { sub: "scog", dur: "1.5h", topic: "Cap. 4 — Fodor: modularità della mente" },
      { sub: "genere", dur: "1h", topic: "Media Digitali Cap. 1 — Network Society (Castells)" },
    ],
  },
  "2026-05-13": {
    label: "Mer 13 Mag",
    ...
    week: 2,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Manuale: Potere, Immagine, Relazioni sociali" },
      { sub: "radio", dur: "1.5h", topic: "Televisioni Cap. 3 — Anni '80, Berlusconi, Fininvest" },
      { sub: "est", dur: "1h", topic: "Il Brutto — da Platone ad Abramovic, Lessing, Herder" },
      { sub: "genere", dur: "1.5h", topic: "Media Digitali Cap. 2 — Genere e sessualità: Butler, queer" },
    ],
  },
  "2026-05-14": {
    label: "Gio 14 Mag",
    ...
    week: 2,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Manuale: Influenzamento + Comunicazione politica" },
      { sub: "scog", dur: "1.5h", topic: "Cap. 4 — Cognizione centrale e tre soluzioni" },
      { sub: "est", dur: "1h", topic: "L'Interessante — Schlegel, Kierkegaard, Moda" },
    ],
  },
  "2026-05-15": { label: "Ven 15 Mag", busy: true, week: 2 },
  "2026-05-16": { label: "Sab 16 Mag", busy: true, week: 2 },
  "2026-05-17": {
    label: "Dom 17 Mag",
    hours: "3h",
    sunday: true,
    week: 2,
    sessions: [
      { sub: "psico", dur: "1h", topic: "Manuale: Ridere e deridere" },
      { sub: "radio", dur: "1h", topic: "Ripasso Televisioni Cap. 1-3 con timeline" },
      { sub: "genere", dur: "0.5h", topic: "Ripasso Media Digitali Cap. 1-2" },
      { sub: "est", dur: "0.5h", topic: "Verifica settimanale" },
    ],
  },
  "2026-05-18": {
    ...
    week: 3,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Ripasso appunti 13 aree: schema riassuntivo" },
      { sub: "radio", dur: "1.5h", topic: "Televisioni Cap. 4 — Anni '90-2010, digitale terrestre" },
      { sub: "scog", dur: "1h", topic: "Cap. 5 — Neuroscienza cognitiva: fMRI, PET, ERP" },
      { sub: "genere", dur: "1.5h", topic: "Media Digitali Cap. 3-4 — Turkle, gender swapping, cybersex" },
    ],
  },
  "2026-05-19": {
    label: "Mar 19 Mag",
    ...
    week: 3,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Simulazione orale: domande casuali 13 aree" },
      { sub: "est", dur: "1.5h", topic: "Il Sublime — Burke, Kant, Schiller, Land Art" },
  ...
  "2026-05-20": {
    ...
    week: 3,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Manuale B1-B8: risposte articolate" },
      { sub: "radio", dur: "1.5h", topic: "Ripasso incrociato Radiodays ↔ Televisioni" },
      { sub: "scog", dur: "1h", topic: "Cap. 5 — Riduzionismo, funzionalismo, neomeccanicismo (Craver)" },
      { sub: "genere", dur: "1.5h", topic: "Media Digitali Cap. 7-9 — Biomediatizzazione + femvertising" },
    ],
  },
  "2026-05-21": {
    label: "Gio 21 Mag",
    ...
    week: 3,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Flashcard veloci: definizioni precise, punti critici" },
      { sub: "est", dur: "1.5h", topic: "Il Kitsch — Broch, Greenberg, Eco, Camp, Koons" },
      { sub: "genere", dur: "1h", topic: "Media Digitali Cap. 10-11 — Femminilità digitale + maschilità" },
    ],
  },
  "2026-05-22": { label: "Ven 22 Mag", busy: true, week: 3 },
  "2026-05-23": { label: "Sab 23 Mag", busy: true, week: 3 },
  "2026-05-24": {
    label: "Dom 24 Mag",
    hours: "3h",
    sunday: true,
    week: 3,
    sessions: [
      { sub: "psico", dur: "1h", topic: "Simulazione orale approfondita" },
      { sub: "radio", dur: "1h", topic: "Ripasso Radio&TV con mappa unificata" },
      { sub: "est", dur: "0.5h", topic: "Ripasso Lady Sapiens + Il Brutto" },
      { sub: "genere", dur: "0.5h", topic: "Verifica settimanale" },
    ],
  },
  "2026-05-25": {
    ...
    week: 4,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Revisione manuale B1-B3 con esempi" },
      { sub: "radio", dur: "1.5h", topic: "Ripasso finale Radiodays Cap. 1-4 con mappe" },
      { sub: "scog", dur: "1h", topic: "Ripasso Cap. 1-2 Comportamentismo + Marr + Algoritmi" },
      { sub: "genere", dur: "1.5h", topic: "Media Digitali Cap. 12-13 — Gender mainstreaming, double bind" },
    ],
  },
  "2026-05-26": {
    label: "Mar 26 Mag",
    ...
    week: 4,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Revisione manuale B4-B5 con scenari" },
      { sub: "est", dur: "1.5h", topic: "Orrore e Terrore — Sontag, Theresienstadt, 11 settembre" },
      { sub: "genere", dur: "1h", topic: "Media Digitali Cap. 14-16 — Attivismo connettivo, meme" },
    ],
  },
  "2026-05-27": {
    label: "Mer 27 Mag",
    ...
    week: 4,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Revisione manuale B6-B8 finale" },
      { sub: "radio", dur: "1.5h", topic: "Ripasso finale Radiodays Cap. 5-8 con timeline" },
      { sub: "scog", dur: "1h", topic: "Ripasso Cap. 4-5 Fodor + Neuroscienza + Riduzionismo" },
      { sub: "genere", dur: "1.5h", topic: "Media Digitali Cap. 17-19 — Cyberfemminismo, violenza online" },
    ],
  },
  "2026-05-28": {
    label: "Gio 28 Mag",
    ...
    week: 4,
    sessions: [
      { sub: "psico", dur: "1.5h", topic: "Simulazione orale finale: 13 aree complete" },
      { sub: "est", dur: "1.5h", topic: "Ripasso Dissonanze: 6 categorie complete" },
      { sub: "genere", dur: "1h", topic: "Richardson Parte 1 — Binario sesso/genere, de Beauvoir" },
    ],
  },
  "2026-05-29": { label: "Ven 29 Mag", busy: true, week: 4 },
  "2026-05-30": { label: "Sab 30 Mag", busy: true, week: 4 },
  "2026-05-31": {
    label: "Dom 31 Mag",
    hours: "3h",
    sunday: true,
    week: 4,
    sessions: [
      { sub: "psico", dur: "1h", topic: "Verifica finale Psicologia" },
      { sub: "radio", dur: "1h", topic: "Verifica finale Radio & TV" },
      { sub: "genere", dur: "0.5h", topic: "Richardson Parte 2-3 — costruzione sociale, Butler + approcci" },
      { sub: "est", dur: "0.5h", topic: "Verifica settimanale" },
    ],
  },
  "2026-06-01": {
  ...
  "2026-06-06": { label: "Sab 6 Giu", busy: true, week: 5 },
  "2026-06-07": {
    label: "Dom 7 Giu",
    hours: "3h",
    sunday: true,
    ...
    sessions: [
      ...
      { sub: "radio", dur: "1h", topic: "Ripasso Radio&TV (esame domani 9 Giu)" },
  ...
  "2026-06-10": {
    ...
    week: 6,
    sessions: [
      { sub: "est", dur: "2.5h", topic: "FINALE ESTETICA — Lady Sapiens + Dissonanze totali" },
